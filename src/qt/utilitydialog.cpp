    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        ...
        QString header = "The ELARVON Core application provides a graphical interface for interacting with " CLIENT_NAME ".\n\n"
                         "It combines the core ELARVON node with a user-friendly interface for wallet management, transaction history, and network statistics.\n\n"
