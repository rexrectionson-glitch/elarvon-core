...
bool OptionsModel::Init(bilingual_str& error)
{
    ...
    const QString explorer_url = QStringLiteral("https://elarvonexplorer.com/?search=%s");
    if (!settings.contains("strThirdPartyTxUrls") || settings.value("strThirdPartyTxUrls").toString().trimmed().isEmpty())
        settings.setValue("strThirdPartyTxUrls", explorer_url);
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", explorer_url).toString();
