...
{
    switch (unit) {
    case Unit::BTC: return QString("ELVN");
    case Unit::mBTC: return QString("mELVN");
    case Unit::uBTC: return QString::fromUtf8("µELVN");
...
{
    switch (unit) {
    case Unit::BTC: return QString("ELARVON");
    case Unit::mBTC: return QString("Milli-ELARVON (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-ELARVON (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
