...
private:
    ...
    bool m_price_available{false};
    bool m_price_cached{false};
    double m_price_usd{0.0};
    double m_price_eur{0.0};
    QString m_price_updated_at;
    QLabel* m_price_status{nullptr};
